 ...
 * admin.php
 * 
 * Moduł administracyjny aplikacji zawierający funkcjonalności:
 * - Uwierzytelnianie użytkowników
 * - Zarządzanie stronami (operacje CRUD)
...
class Admin
{
    ...
    /**
     * Generuje i zwraca formularz logowania do panelu administracyjnego
     * 
     * @return string HTML formularza logowania
     */
     ...
     * 
     * @return string HTML listy podstron
     */
    function ListaPodstron()
    {
        ...
        // Przycisk dodawania nowej strony na górze
        echo '<div class="admin-actions">
            <a href="?idp=create" class="admin-button create">
                <i class="fas fa-plus"></i> Dodaj nową stronę
            </a>
        </div>';
        ...
        while ($row = $result->fetch_assoc()) {
            echo '<tr>
                    ...
                    <td class="action-buttons">
                        <a class="edit-button" href="?idp=edit&ide=' . $row['id'] . '">
                            <i class="fas fa-edit"></i> Edytuj
                        </a>
                        <a class="delete-button" href="?idp=delete&idd=' . $row['id'] . '" onclick="return confirm(\'Czy na pewno chcesz usunąć tę stronę?\');">
    ...
    /**
     * Tworzy nową podstronę
     * 
     * @return string HTML formularza tworzenia nowej podstrony
     */
